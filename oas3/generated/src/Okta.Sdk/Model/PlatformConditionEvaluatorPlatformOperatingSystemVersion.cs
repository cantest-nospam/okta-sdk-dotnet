...
namespace Okta.Sdk.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlatformConditionEvaluatorPlatformOperatingSystemVersion" /> class.
        /// </summary>
        /// <param name="matchType">matchType.</param>
        /// <param name="value">value.</param>
        public PlatformConditionEvaluatorPlatformOperatingSystemVersion(PlatformConditionOperatingSystemVersionMatchType matchType = default(PlatformConditionOperatingSystemVersionMatchType), string value = default(string))
        {
