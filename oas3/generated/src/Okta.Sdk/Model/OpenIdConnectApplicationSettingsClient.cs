...
namespace Okta.Sdk.Model
{
        ...
        public partial class OpenIdConnectApplicationSettingsClient :  IEquatable<OpenIdConnectApplicationSettingsClient>
    {
        ...
        /// <param name="consentMethod">consentMethod.</param>
        /// <param name="grantTypes">grantTypes.</param>
        /// <param name="initiateLoginUri">initiateLoginUri.</param>
        /// <param name="issuerMode">issuerMode.</param>
        /// <param name="idpInitiatedLogin">idpInitiatedLogin.</param>
        ...
        /// <param name="wildcardRedirect">wildcardRedirect.</param>
        /// <param name="responseTypes">responseTypes.</param>
        /// <param name="refreshToken">refreshToken.</param>
        /// <param name="tosUri">tosUri.</param>
        /// <param name="jwks">jwks.</param>
        public OpenIdConnectApplicationSettingsClient(OpenIdConnectApplicationType applicationType = default(OpenIdConnectApplicationType), string clientUri = default(string), OpenIdConnectApplicationConsentMethod consentMethod = default(OpenIdConnectApplicationConsentMethod), List<OAuthGrantType> grantTypes = default(List<OAuthGrantType>), string initiateLoginUri = default(string), OpenIdConnectApplicationIssuerMode issuerMode = default(OpenIdConnectApplicationIssuerMode), OpenIdConnectApplicationIdpInitiatedLogin idpInitiatedLogin = default(OpenIdConnectApplicationIdpInitiatedLogin), string logoUri = default(string), string policyUri = default(string), List<string> postLogoutRedirectUris = default(List<string>), List<string> redirectUris = default(List<string>), string wildcardRedirect = default(string), List<OAuthResponseType> responseTypes = default(List<OAuthResponseType>), OpenIdConnectApplicationSettingsRefreshToken refreshToken = default(OpenIdConnectApplicationSettingsRefreshToken), string tosUri = default(string), OpenIdConnectApplicationSettingsClientKeys jwks = default(OpenIdConnectApplicationSettingsClientKeys))
        {
