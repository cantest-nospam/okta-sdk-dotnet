...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EmailPreview : EmailContentWithSender,  IEquatable<EmailPreview>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailPreview" /> class.
        /// </summary>
        /// <param name="links">links.</param>
        public EmailPreview(EmailPreviewLinks links = default(EmailPreviewLinks), string fromAddress = default(string), string fromName = default(string)) : base(fromAddress, fromName)
        {
            this.Links = links;
        }
