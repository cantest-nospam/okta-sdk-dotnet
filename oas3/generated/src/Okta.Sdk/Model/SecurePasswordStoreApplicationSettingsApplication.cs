...
namespace Okta.Sdk.Model
{
        ...
        public partial class SecurePasswordStoreApplicationSettingsApplication :  IEquatable<SecurePasswordStoreApplicationSettingsApplication>
    {
        ...
        /// </summary>
        /// <param name="optionalField1">optionalField1.</param>
        /// <param name="optionalField1Value">optionalField1Value.</param>
        /// <param name="optionalField2">optionalField2.</param>
        /// <param name="optionalField2Value">optionalField2Value.</param>
        /// <param name="optionalField3">optionalField3.</param>
        /// <param name="optionalField3Value">optionalField3Value.</param>
        /// <param name="passwordField">passwordField.</param>
        /// <param name="url">url.</param>
        /// <param name="usernameField">usernameField.</param>
        public SecurePasswordStoreApplicationSettingsApplication(string optionalField1 = default(string), string optionalField1Value = default(string), string optionalField2 = default(string), string optionalField2Value = default(string), string optionalField3 = default(string), string optionalField3Value = default(string), string passwordField = default(string), string url = default(string), string usernameField = default(string))
        {
