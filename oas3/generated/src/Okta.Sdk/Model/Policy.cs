...
namespace Okta.Sdk.Model
{
        ...
        public partial class Policy :  IEquatable<Policy>
    {
        ...
        public Policy(PolicyRuleConditions conditions = default(PolicyRuleConditions), string description = default(string), string name = default(string), int? priority = default(int?), LifecycleStatus status = default(LifecycleStatus), bool? system = default(bool?), PolicyType type = default(PolicyType))
        {
