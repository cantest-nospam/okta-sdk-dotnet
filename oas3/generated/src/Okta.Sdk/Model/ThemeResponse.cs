...
namespace Okta.Sdk.Model
{
        ...
        public partial class ThemeResponse :  IEquatable<ThemeResponse>
    {
        ...
        /// </summary>
        /// <param name="emailTemplateTouchPointVariant">emailTemplateTouchPointVariant.</param>
        /// <param name="endUserDashboardTouchPointVariant">endUserDashboardTouchPointVariant.</param>
        /// <param name="errorPageTouchPointVariant">errorPageTouchPointVariant.</param>
        /// <param name="primaryColorContrastHex">primaryColorContrastHex.</param>
        /// <param name="primaryColorHex">primaryColorHex.</param>
        /// <param name="secondaryColorContrastHex">secondaryColorContrastHex.</param>
        /// <param name="secondaryColorHex">secondaryColorHex.</param>
        /// <param name="signInPageTouchPointVariant">signInPageTouchPointVariant.</param>
        public ThemeResponse(EmailTemplateTouchPointVariant emailTemplateTouchPointVariant = default(EmailTemplateTouchPointVariant), EndUserDashboardTouchPointVariant endUserDashboardTouchPointVariant = default(EndUserDashboardTouchPointVariant), ErrorPageTouchPointVariant errorPageTouchPointVariant = default(ErrorPageTouchPointVariant), string primaryColorContrastHex = default(string), string primaryColorHex = default(string), string secondaryColorContrastHex = default(string), string secondaryColorHex = default(string), SignInPageTouchPointVariant signInPageTouchPointVariant = default(SignInPageTouchPointVariant))
        {
