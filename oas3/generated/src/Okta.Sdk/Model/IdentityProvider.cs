...
namespace Okta.Sdk.Model
{
        ...
        public partial class IdentityProvider :  IEquatable<IdentityProvider>
    {
        ...
        public IdentityProvider(IssuerMode issuerMode = default(IssuerMode), string name = default(string), IdentityProviderPolicy policy = default(IdentityProviderPolicy), Protocol protocol = default(Protocol), LifecycleStatus status = default(LifecycleStatus), string type = default(string))
        {
