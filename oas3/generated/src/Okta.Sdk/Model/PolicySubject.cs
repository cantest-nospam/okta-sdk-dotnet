...
namespace Okta.Sdk.Model
{
        ...
        public partial class PolicySubject :  IEquatable<PolicySubject>
    {
        ...
        /// <param name="matchAttribute">matchAttribute.</param>
        /// <param name="matchType">matchType.</param>
        /// <param name="userNameTemplate">userNameTemplate.</param>
        public PolicySubject(string filter = default(string), List<string> format = default(List<string>), string matchAttribute = default(string), PolicySubjectMatchType matchType = default(PolicySubjectMatchType), PolicyUserNameTemplate userNameTemplate = default(PolicyUserNameTemplate))
        {
            this.Filter = filter;
            this.Format = format;
