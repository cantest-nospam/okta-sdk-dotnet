...
namespace Okta.Sdk.Model
{
        ...
        public partial class ApplicationSettingsNotificationsVpn :  IEquatable<ApplicationSettingsNotificationsVpn>
    {
        ...
        public ApplicationSettingsNotificationsVpn(string helpUrl = default(string), string message = default(string), ApplicationSettingsNotificationsVpnNetwork network = default(ApplicationSettingsNotificationsVpnNetwork))
        {
