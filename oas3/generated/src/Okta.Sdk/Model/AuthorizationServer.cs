...
namespace Okta.Sdk.Model
{
        ...
        public partial class AuthorizationServer :  IEquatable<AuthorizationServer>
    {
        ...
        public AuthorizationServer(List<string> audiences = default(List<string>), AuthorizationServerCredentials credentials = default(AuthorizationServerCredentials), string description = default(string), string issuer = default(string), IssuerMode issuerMode = default(IssuerMode), string name = default(string), LifecycleStatus status = default(LifecycleStatus))
        {
