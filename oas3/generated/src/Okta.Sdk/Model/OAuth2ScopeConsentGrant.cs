...
namespace Okta.Sdk.Model
{
        ...
        public partial class OAuth2ScopeConsentGrant :  IEquatable<OAuth2ScopeConsentGrant>
    {
        ...
        public OAuth2ScopeConsentGrant(string clientId = default(string), string userId = default(string), OAuth2Actor createdBy = default(OAuth2Actor), string issuer = default(string), string scopeId = default(string), OAuth2ScopeConsentGrantSource source = default(OAuth2ScopeConsentGrantSource), GrantOrTokenStatus status = default(GrantOrTokenStatus))
        {
