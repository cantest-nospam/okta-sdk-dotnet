...
namespace Okta.Sdk.Model
{
        ...
        public partial class SamlApplicationSettingsSignOn :  IEquatable<SamlApplicationSettingsSignOn>
    {
        ...
        /// </summary>
        /// <param name="allowMultipleAcsEndpoints">allowMultipleAcsEndpoints.</param>
        /// <param name="acsEndpoints">acsEndpoints.</param>
        /// <param name="assertionSigned">assertionSigned.</param>
        /// <param name="attributeStatements">attributeStatements.</param>
        /// <param name="audience">audience.</param>
        /// <param name="audienceOverride">audienceOverride.</param>
        /// <param name="authnContextClassRef">authnContextClassRef.</param>
        /// <param name="defaultRelayState">defaultRelayState.</param>
        /// <param name="destination">destination.</param>
        /// <param name="destinationOverride">destinationOverride.</param>
        /// <param name="digestAlgorithm">digestAlgorithm.</param>
        /// <param name="honorForceAuthn">honorForceAuthn.</param>
        /// <param name="idpIssuer">idpIssuer.</param>
        /// <param name="inlineHooks">inlineHooks.</param>
        /// <param name="recipient">recipient.</param>
        /// <param name="recipientOverride">recipientOverride.</param>
        /// <param name="requestCompressed">requestCompressed.</param>
        /// <param name="responseSigned">responseSigned.</param>
        /// <param name="signatureAlgorithm">signatureAlgorithm.</param>
        /// <param name="slo">slo.</param>
        /// <param name="spIssuer">spIssuer.</param>
        /// <param name="ssoAcsUrl">ssoAcsUrl.</param>
        /// <param name="ssoAcsUrlOverride">ssoAcsUrlOverride.</param>
        /// <param name="spCertificate">spCertificate.</param>
        /// <param name="subjectNameIdFormat">subjectNameIdFormat.</param>
        /// <param name="subjectNameIdTemplate">subjectNameIdTemplate.</param>
        public SamlApplicationSettingsSignOn(bool? allowMultipleAcsEndpoints = default(bool?), List<AcsEndpoint> acsEndpoints = default(List<AcsEndpoint>), bool? assertionSigned = default(bool?), List<SamlAttributeStatement> attributeStatements = default(List<SamlAttributeStatement>), string audience = default(string), string audienceOverride = default(string), string authnContextClassRef = default(string), string defaultRelayState = default(string), string destination = default(string), string destinationOverride = default(string), string digestAlgorithm = default(string), bool? honorForceAuthn = default(bool?), string idpIssuer = default(string), List<SignOnInlineHook> inlineHooks = default(List<SignOnInlineHook>), string recipient = default(string), string recipientOverride = default(string), bool? requestCompressed = default(bool?), bool? responseSigned = default(bool?), string signatureAlgorithm = default(string), SingleLogout slo = default(SingleLogout), string spIssuer = default(string), string ssoAcsUrl = default(string), string ssoAcsUrlOverride = default(string), SpCertificate spCertificate = default(SpCertificate), string subjectNameIdFormat = default(string), string subjectNameIdTemplate = default(string))
        {
        ...
        /// </summary>
        [DataMember(Name="allowMultipleAcsEndpoints", EmitDefaultValue=false)]
        ...
        /// </summary>
        [DataMember(Name="assertionSigned", EmitDefaultValue=false)]
        ...
        /// </summary>
        [DataMember(Name="honorForceAuthn", EmitDefaultValue=false)]
        ...
        /// </summary>
        [DataMember(Name="requestCompressed", EmitDefaultValue=false)]
        public bool? RequestCompressed { get; set; }

        /// <summary>
        /// Gets or Sets ResponseSigned
        /// </summary>
        [DataMember(Name="responseSigned", EmitDefaultValue=false)]
        ...
        public bool Equals(SamlApplicationSettingsSignOn input)
        {
            ...
            return 
                (
                    ...
                    (this.AllowMultipleAcsEndpoints != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.AllowMultipleAcsEndpoints != null)
