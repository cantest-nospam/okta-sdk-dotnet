...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BookmarkApplication :  IEquatable<BookmarkApplication>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BookmarkApplication" /> class.
        /// </summary>
        /// <param name="name">name (default to &quot;bookmark&quot;).</param>
        /// <param name="settings">settings.</param>
        public BookmarkApplication(string name = "bookmark", BookmarkApplicationSettings settings = default(BookmarkApplicationSettings))
        {
