...
namespace Okta.Sdk.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityProviderPolicy" /> class.
        /// </summary>
        /// <param name="accountLink">accountLink.</param>
        /// <param name="maxClockSkew">maxClockSkew.</param>
        /// <param name="provisioning">provisioning.</param>
        /// <param name="subject">subject.</param>
        public IdentityProviderPolicy(PolicyAccountLink accountLink = default(PolicyAccountLink), int? maxClockSkew = default(int?), Provisioning provisioning = default(Provisioning), PolicySubject subject = default(PolicySubject))
        {
