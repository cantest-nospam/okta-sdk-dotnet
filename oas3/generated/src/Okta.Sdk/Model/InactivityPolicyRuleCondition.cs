...
namespace Okta.Sdk.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InactivityPolicyRuleCondition" /> class.
        /// </summary>
        /// <param name="number">number.</param>
        /// <param name="unit">unit.</param>
        public InactivityPolicyRuleCondition(int? number = default(int?), string unit = default(string))
        {
            this.Number = number;
            this.Unit = unit;
        }
