...
namespace Okta.Sdk.Model
{
        ...
        public partial class NetworkZone :  IEquatable<NetworkZone>
    {
        ...
        /// <param name="asns">asns.</param>
        public NetworkZone(NetworkZoneType type = default(NetworkZoneType), string name = default(string), bool? system = default(bool?), NetworkZoneUsage usage = default(NetworkZoneUsage), NetworkZoneStatus status = default(NetworkZoneStatus), string proxyType = default(string), List<NetworkZoneLocation> locations = default(List<NetworkZoneLocation>), List<NetworkZoneAddress> gateways = default(List<NetworkZoneAddress>), List<NetworkZoneAddress> proxies = default(List<NetworkZoneAddress>), List<string> asns = default(List<string>))
        {
            this.Type = type;
            this.Name = name;
            this.System = system;
