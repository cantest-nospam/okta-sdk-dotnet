...
namespace Okta.Sdk.Model
{
        ...
        public partial class Protocol :  IEquatable<Protocol>
    {
        ...
        public Protocol(ProtocolAlgorithms algorithms = default(ProtocolAlgorithms), IdentityProviderCredentials credentials = default(IdentityProviderCredentials), ProtocolEndpoints endpoints = default(ProtocolEndpoints), ProtocolEndpoint issuer = default(ProtocolEndpoint), ProtocolRelayState relayState = default(ProtocolRelayState), List<string> scopes = default(List<string>), ProtocolSettings settings = default(ProtocolSettings), ProtocolType type = default(ProtocolType))
        {
