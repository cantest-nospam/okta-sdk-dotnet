...
namespace Okta.Sdk.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationCredentialsSigning" /> class.
        /// </summary>
        /// <param name="kid">kid.</param>
        /// <param name="rotationMode">rotationMode.</param>
        /// <param name="use">use.</param>
        public ApplicationCredentialsSigning(string kid = default(string), string rotationMode = default(string), ApplicationCredentialsSigningUse use = default(ApplicationCredentialsSigningUse))
        {
            this.Kid = kid;
