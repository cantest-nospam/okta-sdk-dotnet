...
namespace Okta.Sdk.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgSetting" /> class.
        /// </summary>
        ...
        /// <param name="endUserSupportHelpURL">endUserSupportHelpURL.</param>
        /// <param name="phoneNumber">phoneNumber.</param>
        /// <param name="postalCode">postalCode.</param>
        /// <param name="state">state.</param>
        /// <param name="supportPhoneNumber">supportPhoneNumber.</param>
        /// <param name="website">website.</param>
        public OrgSetting(Dictionary<string, Object> links = default(Dictionary<string, Object>), string address1 = default(string), string address2 = default(string), string city = default(string), string companyName = default(string), string country = default(string), string endUserSupportHelpURL = default(string), string phoneNumber = default(string), string postalCode = default(string), string state = default(string), string supportPhoneNumber = default(string), string website = default(string))
        {
            this.Links = links;
