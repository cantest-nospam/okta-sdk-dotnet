...
namespace Okta.Sdk.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PolicyRuleConditions" /> class.
        /// </summary>
        /// <param name="app">app.</param>
        /// <param name="apps">apps.</param>
        /// <param name="authContext">authContext.</param>
        /// <param name="authProvider">authProvider.</param>
        /// <param name="beforeScheduledAction">beforeScheduledAction.</param>
        ...
        /// <param name="mdmEnrollment">mdmEnrollment.</param>
        ...
        public PolicyRuleConditions(AppAndInstancePolicyRuleCondition app = default(AppAndInstancePolicyRuleCondition), AppInstancePolicyRuleCondition apps = default(AppInstancePolicyRuleCondition), PolicyRuleAuthContextCondition authContext = default(PolicyRuleAuthContextCondition), PasswordPolicyAuthenticationProviderCondition authProvider = default(PasswordPolicyAuthenticationProviderCondition), BeforeScheduledActionPolicyRuleCondition beforeScheduledAction = default(BeforeScheduledActionPolicyRuleCondition), ClientPolicyCondition clients = default(ClientPolicyCondition), ContextPolicyRuleCondition context = default(ContextPolicyRuleCondition), DevicePolicyRuleCondition device = default(DevicePolicyRuleCondition), GrantTypePolicyRuleCondition grantTypes = default(GrantTypePolicyRuleCondition), GroupPolicyRuleCondition groups = default(GroupPolicyRuleCondition), IdentityProviderPolicyRuleCondition identityProvider = default(IdentityProviderPolicyRuleCondition), MDMEnrollmentPolicyRuleCondition mdmEnrollment = default(MDMEnrollmentPolicyRuleCondition), PolicyNetworkCondition network = default(PolicyNetworkCondition), PolicyPeopleCondition people = default(PolicyPeopleCondition), PlatformPolicyRuleCondition platform = default(PlatformPolicyRuleCondition), RiskPolicyRuleCondition risk = default(RiskPolicyRuleCondition), RiskScorePolicyRuleCondition riskScore = default(RiskScorePolicyRuleCondition), OAuth2ScopesMediationPolicyRuleCondition scopes = default(OAuth2ScopesMediationPolicyRuleCondition), UserIdentifierPolicyRuleCondition userIdentifier = default(UserIdentifierPolicyRuleCondition), UserStatusPolicyRuleCondition userStatus = default(UserStatusPolicyRuleCondition), UserPolicyRuleCondition users = default(UserPolicyRuleCondition))
        {
            this.App = app;
            this.Apps = apps;
