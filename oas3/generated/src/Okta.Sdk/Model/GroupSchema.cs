...
namespace Okta.Sdk.Model
{
        ...
        public partial class GroupSchema :  IEquatable<GroupSchema>
    {
        ...
        public GroupSchema(GroupSchemaDefinitions definitions = default(GroupSchemaDefinitions), string description = default(string), UserSchemaProperties properties = default(UserSchemaProperties), string title = default(string))
        {
