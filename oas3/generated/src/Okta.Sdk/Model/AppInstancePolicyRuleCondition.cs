...
namespace Okta.Sdk.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppInstancePolicyRuleCondition" /> class.
        /// </summary>
        /// <param name="exclude">exclude.</param>
        /// <param name="include">include.</param>
        public AppInstancePolicyRuleCondition(List<string> exclude = default(List<string>), List<string> include = default(List<string>))
        {
