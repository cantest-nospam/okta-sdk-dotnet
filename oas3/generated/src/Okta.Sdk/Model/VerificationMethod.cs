...
namespace Okta.Sdk.Model
{
        ...
        public partial class VerificationMethod :  IEquatable<VerificationMethod>
    {
        ...
        /// <param name="factorMode">factorMode.</param>
        /// <param name="reauthenticateIn">reauthenticateIn.</param>
        /// <param name="type">type.</param>
        public VerificationMethod(List<AccessPolicyConstraints> constraints = default(List<AccessPolicyConstraints>), string factorMode = default(string), string reauthenticateIn = default(string), string type = default(string))
        {
