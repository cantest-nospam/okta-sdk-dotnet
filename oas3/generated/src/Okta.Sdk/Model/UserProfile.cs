...
namespace Okta.Sdk.Model
{
        ...
        public partial class UserProfile :  IEquatable<UserProfile>
    {
        ...
        public UserProfile(string city = default(string), string costCenter = default(string), string countryCode = default(string), string department = default(string), string displayName = default(string), string division = default(string), string email = default(string), string employeeNumber = default(string), string firstName = default(string), string honorificPrefix = default(string), string honorificSuffix = default(string), string lastName = default(string), string locale = default(string), string login = default(string), string manager = default(string), string managerId = default(string), string middleName = default(string), string mobilePhone = default(string), string nickName = default(string), string organization = default(string), string postalAddress = default(string), string preferredLanguage = default(string), string primaryPhone = default(string), string profileUrl = default(string), string secondEmail = default(string), string state = default(string), string streetAddress = default(string), string timezone = default(string), string title = default(string), string userType = default(string), string zipCode = default(string))
        {
            this.City = city;
