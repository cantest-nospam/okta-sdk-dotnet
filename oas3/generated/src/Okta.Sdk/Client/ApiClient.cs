...
namespace Okta.Sdk.Client
{
        ...
        public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = Okta.Sdk.Client.Configuration.Default;
            RestClient = new RestClient("https://{subdomain}.{domain}");
            RestClient.IgnoreResponseStatusCode = true;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://{subdomain}.{domain}).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? Okta.Sdk.Client.Configuration.Default;
        ...
        public ApiClient(String basePath = "https://{subdomain}.{domain}")
        {
